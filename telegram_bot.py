#!/usr/bin/env python3
"""
@far_es_ban - بوت التحكم الكامل
طُوِّر بواسطة: Fares | @I_tt_6
"""
...
# ========== إعدادات البوت ==========
BOT_TOKEN = "8469488876:AAFxGLdbBOB0xYbRcPokw_YFH0VTKaOmRA4"
API_BASE_URL = os.environ.get("API_BASE_URL", "https://mero-host.onrender.com")

# إيدي الأدمن على تليجرام
ADMIN_TELEGRAM_IDS = [8018653004]

# معلومات المطور
DEVELOPER_INFO = "🛠 طُوِّر بواسطة:@far_es_ban *Fares*\n📬 تواصل: "
